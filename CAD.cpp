...
void NS_Composants::CAD::setSQL(String^ rq_sql)
{
...
void NS_Composants::CAD::actionRows(String^ rq_sql)
{
	this->setSQL(rq_sql);
...
DataSet^ NS_Composants::CAD::getRows(String^ rq_sql, String^ dataTableName)
{
	this->setSQL(rq_sql);
